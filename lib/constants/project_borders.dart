...
final class ProjectBorders extends BorderRadius  {
  ...
  const ProjectBorders.onlyCirculartopLeft() : super.only(topLeft: const Radius.circular(24));
  const ProjectBorders.onlyCirculartopRight() : super.only(topRight: const Radius.circular(24));
